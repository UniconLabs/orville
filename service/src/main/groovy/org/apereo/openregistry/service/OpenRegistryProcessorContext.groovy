...
class OpenRegistryProcessorContext {
     ...
     * <strong>
     *     REQUIRED CONTRACT: body -> (Object)a response body; isFinal -> (Boolean)indicates if the outcome is final and no
     ...
     */
    Map<String, Object> outcome = [body: null, isFinal: false]
